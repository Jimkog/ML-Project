...
public class ChiefPage extends JFrame {
	...
	public ChiefPage() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ChiefEmployee che=new ChiefEmployee();
				che.setVisible(true);
				dispose();
			}
		});
		btnNewButton.setBounds(49, 114, 208, 63);
		...
		label.setIcon(new ImageIcon("C:\\Users\\Jimkog\\workspace\\ML Project\\pics\\ecorpssmall2.png"));
		label.setBounds(89, 7, 120, 96);
